...
class XJ_MouseStatus(QObject):#鼠标状态记录器(简易，不适用于复杂情况
    ...
    class Status:#鼠标状态信息(仅在鼠标按下时数据不为None；不处理多按键按下的情况
        ...
        class ClickType(Enum):#点击模式
            ...
            Single=1#鼠标单击
            Double=2#鼠标双击
        # button=ButtonType.Null#按键类型(ButtonType)
        # click=ClickType.Null#点击模式(ClickType)
